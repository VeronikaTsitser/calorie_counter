...
@RoutePage()
class FoodConsumingDetailsScreen extends StatefulWidget {
  const FoodConsumingDetailsScreen({super.key});

  @override
  State<FoodConsumingDetailsScreen> createState() => _FoodConsumingDetailsScreenState();
}

class _FoodConsumingDetailsScreenState extends State<FoodConsumingDetailsScreen> {
